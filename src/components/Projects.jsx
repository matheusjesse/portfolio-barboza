...
import { FaGithub, FaExternalLinkAlt, FaCode, FaDesktop, FaMobile, FaCalculator } from 'react-icons/fa';
            ...
            {projects.filter(project => project.featured).map((project, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {project.highlights && (
                    <ul className="mb-4 p-0 list-none space-y-2">
                        ...
                        <li key={index} className="flex items-start gap-2 text-sm text-gray-700">
                          <span className="mt-0.5 flex-shrink-0 w-4 h-4 rounded-full bg-gray-200 flex items-center justify-center">
                            <svg width="14" height="14" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M5 10.5L9 14.5L15 7.5" stroke="#64748b" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                          </span>
                          <span className="font-medium">{highlight.replace(/^✅\s*/, '')}</span>
                        </li>
                      ))}
                    </ul>
                  )}
